...
function getConfig(projectRoot, options = {}) {
    ...
    function fillAndReturnConfig(config, dynamicConfigObjectType) {
        var _a, _b, _c;
        const configWithDefaultValues = Object.assign(Object.assign({}, ensureConfigHasDefaultValues(projectRoot, config.expo, packageJson, options.skipSDKVersionRequirement)), { mods: config.mods, dynamicConfigObjectType,
        ...
        if (options.isPublicConfig) {
            ...
            if ((_a = configWithDefaultValues.exp.ios) === null || _a === void 0 ? void 0 : _a.config) {
                delete configWithDefaultValues.exp.ios.config;
            }
            if ((_b = configWithDefaultValues.exp.android) === null || _b === void 0 ? void 0 : _b.config) {
                delete configWithDefaultValues.exp.android.config;
            }
        }
        if (options.isModdedConfig) {
            // @ts-ignore: Add the mods back to the object.
            configWithDefaultValues.exp.mods = (_c = config.mods) !== null && _c !== void 0 ? _c : null;
        }
